                    ...
                    >
                        ...
                        {!hasBeenOpened && (
                            ...
                            >
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">Спросите меня что угодно об Илиясе</p>
                                {/* Arrow */}
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 w-[390px] h-[600px] max-h-[85vh] flex flex-col rounded-3xl shadow-2xl z-50 overflow-hidden text-sm border border-primary/20"
                        style={{
                        ...
                        <form onSubmit={handleSubmit} className="p-4 border-t border-white/5 bg-white/[0.02]">
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 focus:border-primary/50 rounded-xl pl-4 pr-12 py-3 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                                />
                                <button
                                    type="submit"
