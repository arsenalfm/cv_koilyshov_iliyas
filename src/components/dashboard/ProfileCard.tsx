        ...
        >
            ...
            <div className="flex flex-col gap-4 mt-5">
                ...
                <div className="flex flex-col gap-2.5">
                    <a href="mailto:iliyas.org@gmail.com" className="flex items-center gap-3 text-gray-500 hover:text-foreground transition-colors text-sm">
                    ...
                    <a href="tel:+77012544415" className="flex items-center gap-3 text-gray-500 hover:text-foreground transition-colors text-sm">
                        <div className="p-2 rounded-lg bg-white/5 dark:bg-black/20 border border-gray-200 dark:border-white/5">
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-white/10">
                    <a href="#" className="flex-1 flex items-center justify-center gap-2 py-2 rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-primary/10 hover:text-primary border border-gray-200 dark:border-white/5 text-gray-500 transition-all text-xs font-medium">
