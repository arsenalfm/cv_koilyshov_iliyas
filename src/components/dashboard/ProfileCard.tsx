        ...
        >
                ...
                <div className="grid grid-cols-3 gap-2">
                    {[
                        ...
                        <motion.div key={m.lbl} whileHover={{ scale: 1.05, y: -2 }} className="text-center p-2.5 rounded-xl bg-primary/5 border border-primary/10 hover:border-primary/30 transition-colors cursor-default">
                            ...
                            <div className="text-xs text-gray-500 dark:text-gray-200 mt-0.5">{m.lbl}</div>
                        </motion.div>
                    ))}
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4 mt-5">
                ...
                <div className="flex flex-col gap-2.5">
                    <a href="mailto:iliyas.org@gmail.com" className="flex items-center gap-3 text-gray-500 dark:text-gray-200 hover:text-foreground transition-colors text-sm">
                    ...
                    <a href="tel:+77012544415" className="flex items-center gap-3 text-gray-500 dark:text-gray-200 hover:text-foreground transition-colors text-sm">
                        <div className="p-2 rounded-lg bg-white/5 dark:bg-black/20 border border-gray-200 dark:border-white/5">
